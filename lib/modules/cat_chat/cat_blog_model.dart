...
class CatBlogComment {
  ...
  factory CatBlogComment.fromRawJson(String str) =>
      CatBlogComment.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory CatBlogComment.fromJson(Map<String, dynamic> json) => CatBlogComment(
        id: json["id"],
        post: json["post"],
        parent: json["parent"],
        author: json["author"],
