            ...
            () => logic.isLoading.value
                ...
                : SizedBox(
                    ...
                    child: Padding(
                      ...
                      child: ListView(
                        children:
                            List.generate(logic.exoticTalklist.length, (index) {
                          return Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                              child: Text(
                                                ...
                                                "Posted on: ${logic.exoticTalklist[index].date}",
                                                softWrap: true,
                                                overflow: TextOverflow.ellipsis,
                                                style: state
                                                    .commentUserSubTitleTextStyle,
                                      ...
                                      Text(
                                        ...
                                        logic.exoticTalklist[index].content
                                            .rendered
                                            .replaceAll(
                                                RegExp(r'<[^>]*>|&[^;]+;'),
                                                ' '),
