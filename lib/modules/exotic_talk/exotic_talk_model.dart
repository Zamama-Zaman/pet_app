...
class ExoticTalkComment {
  ...
  factory ExoticTalkComment.fromRawJson(String str) =>
      ExoticTalkComment.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ExoticTalkComment.fromJson(Map<String, dynamic> json) =>
      ExoticTalkComment(
        id: json["id"],
        post: json["post"],
        parent: json["parent"],
