...
class DogBlogComment {
  ...
  factory DogBlogComment.fromRawJson(String str) =>
      DogBlogComment.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory DogBlogComment.fromJson(Map<String, dynamic> json) => DogBlogComment(
        id: json["id"],
        post: json["post"],
        parent: json["parent"],
        author: json["author"],
